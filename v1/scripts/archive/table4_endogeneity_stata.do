...
gen DU_kw_peer = (iy_sum - DU_kw) / (iy_count - 1)
...
* 第二阶段: 用拟合值替换
predict DU_kw_hat, xbd
* 需要加回FE部分的拟合值 — 直接用reghdfe的fitted
...
esttab ols iv1_ss iv2_ss lag_ols iv3_ss, ///
    ...
    title("Table 4: Second Stage")

di _n "=========================================="
di "SUMMARY: First Stage"
di "=========================================="
